...
#### 8) OPTIONAL: use ITSx to extract the ITS sequences. ####
- Option 1: Run ITSx Directly on ITS reads. Then, just to make this tutorial easier to follow rename the output.

    ITSx --cpu 2 --only_full T --save_regions all -t F -i seqs.filt.derep.mc2.fasta -o ITSx.output
    
    mv ITSx.output seqs.filt.derep.mc2.itsonly.fasta 
...
- Option 2:  Run my script to execute ITSx on multiple CPUs, then concatenate ITS gene output. Then, just to make this tutorial easier to follow, concatenate all the output from the parallel processing:
    ...
    [python parallel_itsx.py](https://gist.github.com/mikerobeson/e9b3e2ab05cb3b7a797a) -i seqs.filt.derep.mc2.fasta -o ITSx.output 24 24000

    $ cat 'all-your-ITS2-fasta-ouput' > seqs.filt.derep.mc2.itsonly.fasta
...
Lets pretend we did this and we end up with the following file:`seqs.filt.itsonly.derep.mc2.itsonly.repset.notpadded.fasta`
...
usearch7 -uchime_ref seqs.filt.derep.mc2.itsonly.repset.notpadded.fasta -db ITSx.ref.db.otus -strand plus -minh 0.5 -nonchimeras seqs.filt.derep.mc2.itsonly.repset.nochimeras.fasta -chimeras seqs.filt.derep.mc2.itsonly.repset.chimeras.fasta -uchimealns seqs.filt.derep.mc2.itsonly.repset.chimeraalns.txt -threads 24
...
filter_fasta.py -a seqs.filt.derep.mc2.itsonly.repset.notpadded.nochimeras.fasta -f  seqs.filt.derep.mc2.itsonly.repset.padded.fasta -o seqs.filt.derep.mc2.itsonly.repset.padded.nochimeras.fasta
...
python fasta_number.py seqs.filt.derep.mc2.itsonly.repset.notpadded.nochimeras.fasta OTU_ > seqs.filt.derep.mc2.itsonly.repset.notpadded.nochimeras.OTUs.fasta
...
usearch7 -usearch_global seqs.filt.fasta -db seqs.filt.derep.mc2.itsonly.repset.notpadded.nochimeras.OTUs.fasta -strand plus -id 0.97 -uc otu.map.uc -threads 24

*Note: I am using the non-N-padded data here. Change this command with the appropriate files.*

#### 15) Make tab-delim OTU table ####
python uc2otutab_mod.py otu.map.uc > seqs.filt.derep.mc2.itsonly.repset.notpadded.nochimeras.OTUTable.txt
...
[biom convert](http://biom-format.org/documentation/biom_conversion.html) --table-type="OTU table" --to-json -i seqs.filt.derep.mc2.itsonly.repset.notpadded.nochimeras.OTUTable.txt -o seqs.filt.derep.mc2.itsonly.repset.notpadded.nochimeras.OTUTable.biom

#### 17) Assign taxonomy using blast, uclust, or rdp. ####
[parallel_assign_taxonomy_blast.py](http://qiime.org/scripts/parallel_assign_taxonomy_blast.html) -v -O 4 -t ITSx.ref.db.tax -r ITSx.ref.db.otus -i seqs.filt.derep.mc2.itsonly.repset.notpadded.nochimeras.OTUs.fasta -o blast_assigned_taxonomy
