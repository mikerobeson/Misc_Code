...
- Option 1: Run ITSx Directly on ITS reads. Then, just to make this tutorial easier to follow rename the output.
    ...
    ITSx --cpu 2 --only_full T --save_regions all -t F -i seqs.fastq -o ITSx.output
    mv ITSx.output seqs.itsonly.fastq 
...
seqs.itsonly.padded.filt.fasta  and  seqs.itsonly.padded.filt.fastq
...
usearch7 -derep_fulllength seqs.itsonly.padded.filt.fasta -output seqs.itsonly.padded.filt.derep.fasta -sizeout 

#### 7) Remove singletons ####
usearch7 -sortbysize seqs.itsonly.padded.filt.derep.fasta -output seqs.itsonly.padded.filt.derep.mc2.fasta -minsize 2

#### 8) Pick OTUs, perform *de novo* chimera checking. ####
usearch7 -cluster_otus seqs.itsonly.padded.filt.derep.mc2.fasta -otus seqs.itsonly.padded.filt.derep.mc2.repset.fasta
...
`seqs.itsonly.notpadded.filt.derep.mc2.repset.fasta`
...
usearch7 -uchime_ref seqs.itsonly.notpadded.filt.derep.mc2.repset.fasta -db ITSx.ref.db.otus -strand plus -minh 0.5 -nonchimeras seqs.itsonly.notpadded.filt.derep.mc2.repset.nochimeras.fasta -chimeras seqs.itsonly.notpadded.filt.derep.mc2.repset.chimeras.fasta -uchimealns seqs.itsonly.notpadded.filt.derep.mc2.repset.chimeraalns.txt -threads 24
...
filter_fasta.py -a seqs.itsonly.notpadded.filt.derep.mc2.repset.nochimeras.fasta -f seqs.itsonly.padded.filt.derep.mc2.repset.fasta -o seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.fasta
...
python fasta_number.py seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.fasta OTU_ > seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.OTUs.fasta
...
usearch7 -usearch_global seqs.itsonly.padded.filt.fasta -db seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.OTUs.fasta -strand plus -id 0.97 -uc otu.map.uc -threads 24

#### 14) Make tab-delim OTU table ####
python uc2otutab_mod.py otu.map.uc > seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.OTUTable.txt
...
[biom convert](http://biom-format.org/documentation/biom_conversion.html) --table-type="OTU table" --to-json -i seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.OTUTable.txt -o seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.OTUTable.biom

#### 16) Assign taxonomy using blast, uclust, or rdp. ####
[parallel_assign_taxonomy_blast.py](http://qiime.org/scripts/parallel_assign_taxonomy_blast.html) -v -O 4 -t ITSx.ref.db.tax -r ITSx.ref.db.otus -i seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.OTUs.fasta -o blast_assigned_taxonomy
...
[biom add-metadata](http://biom-format.org/documentation/adding_metadata.html) -i seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.OTUTable.biom -o seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.OTUTable.blasttax.biom --observation-metadata-fp blast_assigned_taxonomy/seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.OTUs_tax_assignments.txt --observation-header OTUID,taxonomy --sc-separated taxonomy

#### 18) make a tab-delim (classic) version of the OTU table####
biom convert -i seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.OTUTable.blasttax.biom -o seqs.itsonly.padded.filt.derep.mc2.repset.nochimeras.OTUTable.blasttax.txt --to-tsv --header-key taxonomy --output-metadata-id ConsensusLineage
